  ...
  return (
    ...
    <Inicio />
      <div className="d-flex justify-content-evenly mb-5 flex-wrap align-content-center">
        ...
        <a href="/nosotros"><div class="d-flex justify-content-center align-items-center position-relative" data-aos="fade-left">
        <img src={foto4} alt=""  width="350px" height="367px" class="m-4 m-md-4 m-sm-4 border-0" />
